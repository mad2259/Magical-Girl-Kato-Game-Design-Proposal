...
init:
    $ s = Character('Shreya', color=(192, 255, 192, 255))
    $ Christine = Character('Sporty Girl', color=(255, 255, 192, 255))
    $ bg = Character('Both Girls')
    $ narrator = Character(' ')
    $ t = Character(_('Teacher'), color="#ecf5a6")
    $ k = Character(_('Kato'), color="#a6f5a6")
    $ r = Character(_('Rowdy Boy'), color="#944040")
    $ g = Character(_('Goofy Kid'), color="#9b5af5")
...
init:
    ...
    # These are the events with Shreya.
    #
    # The Shreya is studying in the study, but we do not
    # talk to her.
    $ event("s_study",
    ...
    $ event("borrow_pen",
            ...
            # >= 50. 
            "act == 'study' and friendship with Shreya >= 0",
            # It runs only once.
            event.once(),
    ...
    $ event("s_smiling", "act == 'study'",
            event.solo(), event.depends("borrow_pen"),
            priority = 180)

    # The bookslide.
    $ event("bookslide", "act == 'study' and intelligence == 10",
    ...
    $ event("Christine_confess", "act == 'class'",
...
label class_bad:
    ...
    "This is because class was declared with event.only(), which should suspend processing of further events."
...
label study:
    ...
    k "I guess I'll spend some time in the study...."
...
label introduction:
    ...
    t "We have a new student joining us! Kato, why don't you come on up."
    ...
    menu:
        ...
        "Oh god. The introduction. Quick! What do I say???"

        "Take a deep breath. Calm your mind before speaking":
...
label vomit: 
    ...
    c "... to this town. And we hope to be friends with all of you."

    c "Well, that's about it. Sis, do you have anything to say?"

    "The girl with glasses pauses for a second, and then quickly says:"

    s "{size=-4}It's good to meet you all.{/size}"
...
label s_studying:
    ...
    "I head to the study, to get some studying done."

    "The Shreya is there, but she's busy reading a book, taking
...
label borrow_pen:
    ...
    "The Shreya is there, but she's busy reading a book."
    ...
    "I look up, and see the Shreya standing right next to me."

    s "Excuse me, but can I borrow your pen?"

    s "Mine ran out of ink."
    ...
    s "Hm... I guess you're right."

    s "There's so much stuff here, and I want to know about it all."

    s "Surely, you must feel the same way, as you're here almost as
        much as I am."
...
label s_smiling:
    ...
    "The Shreya is there, and smiles at me for a second before
...
label bookslide:
    ...
    "The Shreya is standing right by the entrance, putting a
...
label cookies:
    ...
    "The Shreya is there, apparently waiting for me."
...
label s_confess:
    ...
    "Standing there, I find the Shreya."
...
label catchme:
    ...
    c "I didn't know you were a runner."
    ...
    c "As if! You couldn't keep up with me."
    ...
    c "See? Well, maybe we can try it again when you're a bit
        faster."
...
label cantcatchme:
    ...
    c "Well, keep up the good work. One day you'll be as fast as me!"
...
label caughtme:
    ...
    c "You've been practicing, and it really shows."
    
    c "You've finally become fast enough to run with me."

    "I nod, accepting her praise."

    c "We should do this more often... it's better to run with
...
label apart:
    ...
    c "It's your own fault... this is what you get for not
        practicing."
...
label pothole:
    ...
    c "I... hit a... pothole. Twisted my... ankle."
...
label Christine_confess:
    ...
    c "I went to the doctor, and he gave me this."

    c "Looks like we won't be running together for a while."

    "I nod."

    c "And that's why I asked you here."

    c "I couldn't stand the though of not seeing you for a few
        weeks."
...
label both_confess:
    ...
    c "Well, I invited you up here to confess to you..."

    c "... and then I found out that my sister here was about to do
        the same thing."

    s "{size=-4}...I was...{/size}"

    c "When we found out, we were quite shocked, but after comparing
